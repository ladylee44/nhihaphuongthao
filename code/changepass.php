...
ob_start();
session_start();
// to change password after typing the code
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <div>
            <div>
                <form  action="" method="post" >
                            ...
                            <div class="main_area">
                                <h3 class="heading_2" style=" "><span class="text">Change your Password</span></h3>
                                ...
                                <div>
                                    <div>
                                        <table style="position: relative; left: 40px; margin-bottom: 20px;">
                                            <tr>
                                                <td></td>
                                                <td><div class="entertxt">Type the password in the field below and click confirm.</div>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td></td>
                                                <td><input class="type_email" type="password" name="pass" placeholder="Enter new password"/>
                                                </td>
                                                </tr>
                                                <tr>
                                                <td></td>
                                                ...
                                                <div>
                                                    <div class="bottom_button"><input value="Confirm" type="submit" name="submit" class="submit_button" /><a href="index.php" class="cancel_button">
                                                        Cancel</a>
                                                        </div>
