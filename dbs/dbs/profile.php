...
<body>        
<a href="config.php">Home</a> | <?php echo $profile_data['username'] ?>'s Profile <h3>Personal Information |        
<?php 
$visitor = $_SESSION['username'];            
if ($user == $visitor ) { ?>  
<a href="editprofile.php?user=<?php 
echo $profile_data['username'] ?>">Edit Profile</a>            
